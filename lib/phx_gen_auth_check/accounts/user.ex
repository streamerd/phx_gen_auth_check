defmodule PhxGenAuthCheck.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, PhxGenAuthCheck.Repo)
  ...
  """
  def valid_password?(%PhxGenAuthCheck.Accounts.User{hashed_password: hashed_password}, password)
