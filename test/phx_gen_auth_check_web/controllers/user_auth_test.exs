defmodule PhxGenAuthCheckWeb.UserAuthTest do
  use PhxGenAuthCheckWeb.ConnCase, async: true

  alias PhxGenAuthCheck.Accounts
  alias PhxGenAuthCheckWeb.UserAuth
  import PhxGenAuthCheck.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, PhxGenAuthCheckWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      PhxGenAuthCheckWeb.Endpoint.subscribe(live_socket_id)
